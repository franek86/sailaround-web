  ...
  return (
    <>
      ...
      <section className='my-6 grid gap-6 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3'>
        <ManagerCard title='Countries' link='/manager/countries' shortText='Here, you can view the list of countries, add new ones, edit existing entries, or delete countries as needed.' />
